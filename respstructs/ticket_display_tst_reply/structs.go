...
type TicketDisplayTSTReply struct {
	...
	} `xml:"applicationError,omitempty"`
	...
	FareList struct {
		...
		} `xml:"passengerInformation,omitempty"`
		...
		} `xml:"segmentInformation,omitempty"`
		...
		} `xml:"warningInformation,omitempty"`

		AutomaticReissueInfo struct {
			...
			} `xml:"firstDpiGroup,omitempty"`

			SecondDpiGroup struct {
			...
			} `xml:"secondDpiGroup,omitempty"`
		} `xml:"automaticReissueInfo,omitempty"`

		CarrierFeesGroup struct {

			// Airline Ticketing Fees : OB
			CarrierFeeType *SelectionDetailsTypeI `xml:"carrierFeeType,omitempty"`

			CarrierFeeInfo struct {
			...
			} `xml:"carrierFeeInfo,omitempty"`
		} `xml:"carrierFeesGroup,omitempty"`
