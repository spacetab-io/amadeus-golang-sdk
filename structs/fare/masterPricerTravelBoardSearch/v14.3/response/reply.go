package Fare_MasterPricerTravelBoardSearchResponse_v14_3 // fmptbr143
...
type TravelProductType struct {
	...
	// Attribute details
	AttributeDetails []*CodedAttributeInformationType_260992C `xml:"attributeDetails,omitempty"` // maxOccurs="20"
}
