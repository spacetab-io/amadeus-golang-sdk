package Fare_InformativeBestPricingWithoutPNRReply_v12_4 // tibnrr124

//import "encoding/xml"

type FareInformativeBestPricingWithoutPNRReply struct {
	// XMLName xml.Name `xml:"http://xml.amadeus.com/TIBNRR_12_4_1A Fare_InformativeBestPricingWithoutPNRReply"`
...
type FareInfoGroup struct {
	...
	PricingIndicators *PricingTicketingDetailsType `xml:"pricingIndicators,omitempty"` // minOccurs="0"

	FareAmount *MonetaryInformationType_157223S `xml:"fareAmount,omitempty"` // minOccurs="0"
...
type SegmentLevelGroup struct {
	...
	SegmentInformation *TravelProductInformationTypeI_33489S `xml:"segmentInformation"`
	...
	AdditionalInformation *PricingTicketingDetailsType `xml:"additionalInformation,omitempty"` // minOccurs="0"
...
type Group29 struct {
	...
	// Reserved for a future use to store a structured fare calculation line. NOT IMPLEMENTED.
	StructuredFareCalcG28TVL *TravelProductInformationTypeI_33489S `xml:"structuredFareCalcG28TVL,omitempty"` // minOccurs="0"
}
...
type LocationTypeI_58141C struct {
	// Format limitations: an..25
	TrueLocationId string `xml:"trueLocationId,omitempty"` // minOccurs="0"
...
type MonetaryInformationDetailsType_223868C struct {
	// Format limitations: an..3
	TypeQualifier string `xml:"typeQualifier"`
...
type MonetaryInformationType_157223S struct {
	MonetaryDetails *MonetaryInformationDetailsType_223868C `xml:"monetaryDetails"`

	OtherMonetaryDetails []*MonetaryInformationDetailsType_223868C `xml:"otherMonetaryDetails,omitempty"` // minOccurs="0" maxOccurs="99"
}
...
type PricingTicketingDetailsTypeI struct {
	...
	IdNumber *int32 `xml:"idNumber,omitempty"` // minOccurs="0"
...
type TravelProductInformationTypeI_33489S struct {
	FlightDate *ProductDateTimeTypeI `xml:"flightDate,omitempty"` // minOccurs="0"

	BoardPointDetails *LocationTypeI_58141C `xml:"boardPointDetails,omitempty"` // minOccurs="0"

	OffpointDetails *LocationTypeI_58141C `xml:"offpointDetails,omitempty"` // minOccurs="0"
