...
func (s *service) SalesReportsDisplayQueryReport(query *SalesReports_QueryReportRequest_v10_1.Request) (*SalesReports_QueryReportReply_v10_1.Response, *sdk.ResponseSOAPHeader, error) {
	return s.sdk.SalesReportsDisplayQueryReportV101(query)
}

func (s *service) TicketCancelDocument(query *Ticket_CancelDocument_v11_1.Request) (*Ticket_CancelDocument_v11_1.Response, *sdk.ResponseSOAPHeader, error) {
	return s.sdk.TicketCancelDocumentV111(query)
}

func (s *service) TicketDeleteTST(query *Ticket_DeleteTST_v04_1.Request) (*Ticket_DeleteTST_v04_1.Response, *sdk.ResponseSOAPHeader, error) {
