package Fare_MasterPricerTravelBoardSearchRequest_v16_3 // fmptbq163
...
type Request struct {
	...
	// Traveler Details
	PaxReference []*TravellerReferenceInformationType `xml:"paxReference,omitempty"` // maxOccurs="9"

	// Customer references
	CustomerRef *ConsumerReferenceInformationType `xml:"customerRef,omitempty"`

	// Search options
	SearchOptions []*AttributeList `xml:"searchOptions,omitempty"` // maxOccurs="10"
	...
	TravelFlightInfo *TravelFlightInformationType_199258S `xml:"travelFlightInfo,omitempty"`

	ValueSearch []*ValueSearchCriteriaType `xml:"valueSearch,omitempty"` // maxOccurs="99"

	Buckets []*Buckets `xml:"buckets,omitempty"` // maxOccurs="10"
...
type FareOptions struct {
	...
	// PSR number
	FeeIdDescription *CodedAttributeType_199259S `xml:"feeIdDescription,omitempty"`
...
type Buckets struct {
	...
	// Bucket details
	BucketDetails []*BucketDetailsType `xml:"bucketDetails,omitempty"` // maxOccurs="15"
}
...
type Itinerary struct {
	...
	FlightInfo *TravelFlightInformationType_199585S `xml:"flightInfo,omitempty"`
...
type ArrivalLocalizationType struct {
	...
	ArrivalMultiCity []*MultiCityOptionType `xml:"arrivalMultiCity,omitempty"` // maxOccurs="50"
...
type AttributeDetails struct {
	// Qualifier
	Qualifier formats.AlphaNumericString_Length1To5 `xml:"qualifier,omitempty"`

	// Value
	Value []formats.AlphaNumericString_Length1To64 `xml:"value,omitempty"` // maxOccurs="20"
}

type AttributeDetailsType struct {
	// Reference of the requested segment
	RequestedSgt formats.AlphaNumericString_Length1To3 `xml:"requestedSgt,omitempty"`

	// List of airlines, cabins, time window, number of connections.
	Value []formats.AlphaNumericString_Length1To20 `xml:"value,omitempty"` // maxOccurs="50"
}
...
type AttributeList struct {
	...
	// Attribute details
	AttributeDetails []*AttributeDetails `xml:"attributeDetails,omitempty"` // maxOccurs="10"
}
...
type BucketDetailsType struct {
	...
	// Attribute
	Attribute []*AttributeDetailsType `xml:"attribute,omitempty"` // maxOccurs="10"
}

type BucketInformationType struct {
	// Number
	Number formats.AlphaNumericString_Length1To3 `xml:"number,omitempty"`

	// Name
	Name formats.AlphaNumericString_Length1To20 `xml:"name,omitempty"`

	// Completion
	Completion formats.AMA_EDICodesetType_Length1to3 `xml:"completion,omitempty"`

	// Mode
	Mode formats.AlphaNumericString_Length1To3 `xml:"mode,omitempty"`

	// Value reference
	ValueRef formats.AlphaNumericString_Length1To3 `xml:"valueRef,omitempty"`

	// Weight
	Weight *formats.NumericInteger_Length1To4 `xml:"weight,omitempty"`

	// Number of solutions in the bucket
	Count *formats.NumericInteger_Length1To6 `xml:"count,omitempty"`

	// Number of solutions per attribute
	AttributeCount *formats.NumericInteger_Length1To6 `xml:"attributeCount,omitempty"`
}
...
type CodedAttributeType_199259S struct {
	// Fee/reduction Id
	FeeId []*CodedAttributeInformationType_277155C `xml:"feeId,omitempty"` // maxOccurs="20"
}
...
type DepartureLocationType struct {
	...
	DepMultiCity []*MultiCityOptionType `xml:"depMultiCity,omitempty"` // maxOccurs="50"
...
type TravelFlightInformationType_199258S struct {
	...
	// Company Identification
	CompanyIdentity []*CompanyIdentificationType_275415C `xml:"companyIdentity,omitempty"` // maxOccurs="20"
...
type TravellerReferenceInformationType struct {
	...
	Ptc []formats.AlphaNumericString_Length1To6 `xml:"ptc,omitempty"` // maxOccurs="4"
