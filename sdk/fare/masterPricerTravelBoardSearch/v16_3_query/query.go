package Fare_MasterPricerTravelBoardSearch_v16_3 // fmptbq163
...
type FareMasterPricerTravelBoardSearch struct {
	XMLName xml.Name `xml:"http://xml.amadeus.com/FMPTBQ_16_3_1A Fare_MasterPricerTravelBoardSearch"`
	...
	// Traveler Details
	PaxReference []*TravellerReferenceInformationType `xml:"paxReference,omitempty"` // minOccurs="0" maxOccurs="9"

	// Customer references
	CustomerRef *ConsumerReferenceInformationType `xml:"customerRef,omitempty"` // minOccurs="0"

	// Search options
	SearchOptions []*AttributeList `xml:"searchOptions,omitempty"` // minOccurs="0" maxOccurs="10"
	...
	TravelFlightInfo *TravelFlightInformationType_199258S `xml:"travelFlightInfo,omitempty"` // minOccurs="0"

	ValueSearch []*ValueSearchCriteriaType `xml:"valueSearch,omitempty"` // minOccurs="0" maxOccurs="99"

	Buckets []*Buckets `xml:"buckets,omitempty"` // minOccurs="0" maxOccurs="10"
...
type FareFamilies struct {
	...
	FamilyInformation *FareFamilyType_80157S `xml:"familyInformation"`
...
type FareOptions struct {
	...
	// PSR number
	FeeIdDescription *CodedAttributeType_199259S `xml:"feeIdDescription,omitempty"` // minOccurs="0"
...
type Buckets struct {
	...
	// Bucket details
	BucketDetails []*BucketDetailsType `xml:"bucketDetails,omitempty"` // minOccurs="0" maxOccurs="15"
}
...
type Itinerary struct {
	...
	FlightInfo *TravelFlightInformationType_199585S `xml:"flightInfo,omitempty"` // minOccurs="0"

	// Segment used to target Commercial Fare Family at requested segment level
	FamilyInformation *FareFamilyType `xml:"familyInformation,omitempty"` // minOccurs="0"
	...
	// Coded attributes
	Attributes *CodedAttributeType `xml:"attributes,omitempty"` // minOccurs="0"
}
...
type ArrivalLocalizationType struct {
	...
	ArrivalMultiCity []*MultiCityOptionType `xml:"arrivalMultiCity,omitempty"` // minOccurs="0" maxOccurs="50"
...
type AttributeDetails struct {
	// Qualifier
	Qualifier formats.AlphaNumericString_Length1To5 `xml:"qualifier,omitempty"` // minOccurs="0"

	// Value
	Value []formats.AlphaNumericString_Length1To64 `xml:"value,omitempty"` // minOccurs="0" maxOccurs="20"
}

type AttributeDetailsType struct {
	// Reference of the requested segment
	RequestedSgt formats.AlphaNumericString_Length1To3 `xml:"requestedSgt,omitempty"` // minOccurs="0"

	// List of airlines, cabins, time window, number of connections.
	Value []formats.AlphaNumericString_Length1To20 `xml:"value,omitempty"` // minOccurs="0" maxOccurs="50"
}
...
type AttributeList struct {
	...
	// Attribute details
	AttributeDetails []*AttributeDetails `xml:"attributeDetails,omitempty"` // minOccurs="0" maxOccurs="10"
}
...
type BucketDetailsType struct {
	...
	// Attribute
	Attribute []*AttributeDetailsType `xml:"attribute,omitempty"` // minOccurs="0" maxOccurs="10"
}

type BucketInformationType struct {
	// Number
	Number formats.AlphaNumericString_Length1To3 `xml:"number,omitempty"` // minOccurs="0"

	// Name
	Name formats.AlphaNumericString_Length1To20 `xml:"name,omitempty"` // minOccurs="0"

	// Completion
	Completion formats.AMA_EDICodesetType_Length1to3 `xml:"completion,omitempty"` // minOccurs="0"

	// Mode
	Mode formats.AlphaNumericString_Length1To3 `xml:"mode,omitempty"` // minOccurs="0"

	// Value reference
	ValueRef formats.AlphaNumericString_Length1To3 `xml:"valueRef,omitempty"` // minOccurs="0"

	// Weight
	Weight *formats.NumericInteger_Length1To4 `xml:"weight,omitempty"` // minOccurs="0"

	// Number of solutions in the bucket
	Count *formats.NumericInteger_Length1To6 `xml:"count,omitempty"` // minOccurs="0"

	// Number of solutions per attribute
	AttributeCount *formats.NumericInteger_Length1To6 `xml:"attributeCount,omitempty"` // minOccurs="0"
}
...
type CodedAttributeInformationType_277155C struct {
...
type CodedAttributeType_199259S struct {
	// Fee/reduction Id
	FeeId []*CodedAttributeInformationType_277155C `xml:"feeId,omitempty"` // minOccurs="0" maxOccurs="20"
}
...
type CompanyIdentificationType_275415C struct {
	// Item description identification.
	CarrierQualifier formats.AlphaNumericString_Length0To1 `xml:"carrierQualifier"`
...
type DepartureLocationType struct {
	...
	DepMultiCity []*MultiCityOptionType `xml:"depMultiCity,omitempty"` // minOccurs="0" maxOccurs="50"
...
type FareFamilyType_80157S struct {
...
type NumberOfUnitDetailsType_270113C struct {
	// Number of Units
...
type NumberOfUnitsType struct {
	...
	UnitNumberDetail []*NumberOfUnitDetailsType_270113C `xml:"unitNumberDetail"` // maxOccurs="20"
}
...
type TravelFlightInformationType_199258S struct {
	// Cabin identification
	CabinId *CabinIdentificationType_233500C `xml:"cabinId,omitempty"` // minOccurs="0"

	// Company Identification
	CompanyIdentity []*CompanyIdentificationType_275415C `xml:"companyIdentity,omitempty"` // minOccurs="0" maxOccurs="20"
...
type TravelFlightInformationType_199585S struct {
	// Cabin identification
	CabinId *CabinIdentificationType_233500C `xml:"cabinId,omitempty"` // minOccurs="0"
...
type TravellerReferenceInformationType struct {
	...
	Ptc []formats.AlphaNumericString_Length1To6 `xml:"ptc,omitempty"` // minOccurs="0" maxOccurs="4"
