...
func (service *WebServicesPTSOAP4Header) AirFlightInfo(session *Session_v3, messageId string, request *flireq051.AirFlightInfo) (*flires051.AirFlightInfoReply, *ResponseSOAP4Header, error) {
	soapAction := "FLIREQ_05_1_1A"

	response := new(flires051.AirFlightInfoReply)
	header, err := service.client.Call(url + soapAction, messageId, request, response, session)
	if err != nil {
...
func (service *WebServicesPTSOAP4Header) AirSellFromRecommendation(session *Session_v3, messageId string, request *itareq052.AirSellFromRecommendation) (*itares052.AirSellFromRecommendationReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) CommandCryptic(session *Session_v3, messageId string, request *hsfreq073.CommandCryptic) (*hsfres073.CommandCrypticReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) DocIssuanceIssueTicket(session *Session_v3, messageId string, request *ttktiq091.DocIssuanceIssueTicket) (*ttktir091.DocIssuanceIssueTicketReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareCheckRules(session *Session_v3, messageId string, request *farqnq071.FareCheckRules) (*farqnr071.FareCheckRulesReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareConvertCurrency(session *Session_v3, messageId string, request *fcuqcq081.FareConvertCurrency) (*fcuqcr081.FareConvertCurrencyReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareInformativeBestPricingWithoutPNR(session *Session_v3, messageId string, request *tibnrq124.FareInformativeBestPricingWithoutPNR) (*tibnrr124.FareInformativeBestPricingWithoutPNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareInformativePricingWithoutPNR(session *Session_v3, messageId string, request *tipnrq124.FareInformativePricingWithoutPNR) (*tipnrr124.FareInformativePricingWithoutPNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareMasterPricerCalendar(session *Session_v3, messageId string, request *fmpcaq143.FareMasterPricerCalendar) (*fmpcar143.FareMasterPricerCalendarReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareMasterPricerCalendarOld(session *Session_v3, messageId string, request *fmpcaq122.FareMasterPricerCalendarOld) (*fmpcar122.FareMasterPricerCalendarOldReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareMasterPricerTravelBoardSearchNew(session *Session_v3, messageId string, request *fmptbq163.FareMasterPricerTravelBoardSearch) (*fmptbr163.FareMasterPricerTravelBoardSearchReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareMasterPricerTravelBoardSearch(session *Session_v3, messageId string, request *fmptbq143.FareMasterPricerTravelBoardSearch) (*fmptbr143.FareMasterPricerTravelBoardSearchReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FareMasterPricerTravelBoardSearchOld(session *Session_v3, messageId string, request *fmptbq123.FareMasterPricerTravelBoardSearchOld) (*fmptbr123.FareMasterPricerTravelBoardSearchOldReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FarePricePNRWithBookingClass(session *Session_v3, messageId string, request *tpcbrq141.FarePricePNRWithBookingClass) (*tpcbrr141.FarePricePNRWithBookingClassReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) FarePricePNRWithBookingClassOld(session *Session_v3, messageId string, request *tpcbrq124.FarePricePNRWithBookingClassOld) (*tpcbrr124.FarePricePNRWithBookingClassOldReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) PNRAddMultiElements(session *Session_v3, messageId string, request *pnradd113.PNRAddMultiElements) (*pnracc113.PNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) PNRCancel(session *Session_v3, messageId string, request *pnrxcl113.PNRCancel) (*pnracc113.PNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) PNRRetrieve(session *Session_v3, messageId string, request *pnrret113.PNRRetrieve) (*pnracc113.PNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) PNRRetrieve2(session *Session_v3, messageId string, request *pnrret113.PNRRetrieve) (*tnlres001.PNRList, *ResponseSOAP4Header, error) {
	soapAction := "PNRRET_11_3_1A"
...
func (service *WebServicesPTSOAP4Header) QueueCountPlanner(session *Session_v3, messageId string, request *qcddrq031.QueueCountPlanner) (*qcddrr031.QueueCountPlannerReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) QueueCountTotal(session *Session_v3, messageId string, request *qcsdrq031.QueueCountTotal) (*qcsdrr031.QueueCountTotalReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) QueueList(session *Session_v3, messageId string, request *qdqlrq111.QueueList) (*qdqlrr111.QueueListReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) QueueMoveItem(session *Session_v3, messageId string, request *quqmuq031.QueueMoveItem) (*quqmur031.QueueMoveItemReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) QueuePlacePNR(session *Session_v3, messageId string, request *quqpcq031.QueuePlacePNR) (*quqpcr031.QueuePlacePNRReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) QueueRemoveItem(session *Session_v3, messageId string, request *quqmdq031.QueueRemoveItem) (*quqmdr031.QueueRemoveItemReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) SecuritySignOut(session *Session_v3, messageId string, request *vlssoq041.SecuritySignOut) (*vlssor041.SecuritySignOutReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) TicketCreateTSTFromPricing(session *Session_v3, messageId string, request *tautcq041.TicketCreateTSTFromPricing) (*tautcr041.TicketCreateTSTFromPricingReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) TicketCreditCardCheck(session *Session_v3, messageId string, request *ccvrqt061.TicketCreditCardCheck) (*ccvrsp061.TicketCreditCardCheckReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) TicketDeleteTST(session *Session_v3, messageId string, request *ttstdq041.TicketDeleteTST) (*ttstdr041.TicketDeleteTSTReply, *ResponseSOAP4Header, error) {
...
func (service *WebServicesPTSOAP4Header) TicketDisplayTST(session *Session_v3, messageId string, request *ttstrq071.TicketDisplayTST) (*ttstrr071.TicketDisplayTSTReply, *ResponseSOAP4Header, error) {
