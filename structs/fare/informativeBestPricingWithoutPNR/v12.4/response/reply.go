package Fare_InformativeBestPricingWithoutPNRResponse_v12_4 // tibnrr124
...
type FareInfoGroup struct {
	...
	PricingIndicators *PricingTicketingDetailsType `xml:"pricingIndicators,omitempty"`

	FareAmount *MonetaryInformationType_157223S `xml:"fareAmount,omitempty"`
...
type SegmentLevelGroup struct {
	...
	AdditionalInformation *PricingTicketingDetailsType `xml:"additionalInformation,omitempty"`
...
type Group29 struct {
	...
	// Reserved for a future use to store a structured fare calculation line. NOT IMPLEMENTED.
	StructuredFareCalcG28TVL *TravelProductInformationTypeI_33489S `xml:"structuredFareCalcG28TVL,omitempty"`
}
...
type MonetaryInformationType_157223S struct {
	...
	OtherMonetaryDetails []*MonetaryInformationDetailsType_223868C `xml:"otherMonetaryDetails,omitempty"` // maxOccurs="99"
}
...
type PricingTicketingDetailsTypeI struct {
	...
	IdNumber *int32 `xml:"idNumber,omitempty"`
...
type TravelProductInformationTypeI_33489S struct {
	...
	BoardPointDetails *LocationTypeI_58141C `xml:"boardPointDetails,omitempty"`

	OffpointDetails *LocationTypeI_58141C `xml:"offpointDetails,omitempty"`
